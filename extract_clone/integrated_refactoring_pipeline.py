...
def main():
    ...
    parser.add_argument("--out_sampled_json", required=True, help="Output path for the filtered 100 samples in standard JSON format")
    ...
    os.makedirs(os.path.dirname(args.out_sampled_json), exist_ok=True)
    ...
    with open(args.out_sampled_json, "w", encoding="utf-8") as f:
        json.dump(sampled_records, f, indent=4)
            
    print(f"\n[2/3] Saved {len(sampled_records)} strictly sampled constraints pairs to {args.out_sampled_json}")
