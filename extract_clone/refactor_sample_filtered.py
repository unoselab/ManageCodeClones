...
input_path = Path("/home/user1-system11/research_dream/llm-clone/extract_clone/output/sampling_clones/sampled_70pairs_after_ref.json")
output_path = Path("/home/user1-system11/research_dream/llm-clone/extract_clone/output/sampling_clones/sampled_70pairs_excluding_refactored_false.json")
