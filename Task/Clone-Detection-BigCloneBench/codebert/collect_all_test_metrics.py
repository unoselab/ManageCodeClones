...
# Path configuration
#LOG_PATH = Path("/home/user1-system11/research_dream/llm-clone/Task/Clone-Detection-BigCloneBench/codebert/saved_models_bcb/logs/test_all_systems_bcb_java_block_function.log")
LOG_PATH = Path("/home/user1-system11/research_dream/llm-clone/Task/Clone-Detection-BigCloneBench/codebert/saved_models_combined/logs/test_all_systems_bcb_java_block_function.log")

OUT_CSV = Path("/home/user1-system11/research_dream/llm-clone/Task/Clone-Detection-BigCloneBench/codebert/saved_models_combined/repo_metrics_codebert_bcb_java_block_function_after_adaption.csv")
...
RE_PAIRS = re.compile(r"pairs_loaded=(\d+)")
