...
# Path configuration
LOG_PATH = Path("/home/user1-system11/research_dream/llm-clone/Task/Clone-Detection-BigCloneBench/graphcodebert/saved_models_combined/logs/test_all_systems_graphcodebert_bcb_java_block_function.log")
OUT_CSV = Path("/home/user1-system11/research_dream/llm-clone/Task/Clone-Detection-BigCloneBench/graphcodebert/saved_models_combined/repo_metrics_graphcodebert_bcb_java_block_function_after_adaption.csv")
