...
mkdir -p "$OUT_ROOT/predictions_python" "$OUT_ROOT/logs"

# ---- one single log file for everything ----
RUN_LOG="$OUT_ROOT/logs/test_all_systems_graphcodebert_bcb_python_combined.log"
...
# Collect systems (exclude bck/org and require files)
systems=()
...
for sys in "${systems[@]}"; do
  ...
  preds_rel="predictions_python/predictions_${sys}_test.txt"
