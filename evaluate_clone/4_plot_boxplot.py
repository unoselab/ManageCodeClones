...
from scipy.stats import wilcoxon  # Added for statistical testing
...
def generate_boxplot(jsonl_path: str, output_path: str):
    ...
    # We need to pair the 'before' and 'after' scores for each project
    df_pivot = df.pivot(index='subject', columns='adapt', values='avg').dropna()
    ...
    plt.ylabel('Average RCP Score', fontsize=12, labelpad=10)
