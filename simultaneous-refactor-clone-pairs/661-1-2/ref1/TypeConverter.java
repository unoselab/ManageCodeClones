...
public class TypeConverter {
    ...
    public static final IRubyObject convertToType(IRubyObject obj, RubyClass target, int convertMethodIndex, String convertMethod, boolean raise) {
        return extracted(obj, target, convertMethod, raise);
    }
    private static IRubyObject extracted(IRubyObject obj, RubyClass target, String convertMethod, boolean raise) {
