...
python3 integrate_refactoring_pipeline.py \
  --jsonl_dir "/home/user1-system11/research_dream/llm-clone/extract_clone_py/data/augmented_post_nicad_blocks" \
  --gt_dir "/home/user1-system11/research_dream/llm-clone/Task/Clone-Detection-BigCloneBench/dataset/nicad_block_python" \
  --pred_dir "/home/user1-system11/research_dream/llm-clone/Task/Clone-Detection-BigCloneBench/codebert/saved_models_bcb/predictions_python_block" \
  --pred_adapt_dir "/home/user1-system11/research_dream/llm-clone/Task/Clone-Detection-BigCloneBench/codebert/saved_models_combined_py/predictions_python_block" \
  --out_all_jsonl "/home/user1-system11/research_dream/llm-clone/extract_clone_py/output/sampling_clones/all_evaluated_pairs.jsonl" \
  --out_sampled_jsonl "/home/user1-system11/research_dream/llm-clone/extract_clone_py/output/sampling_clones/sampled_100_pairs.jsonl" \
  --out_html "/home/user1-system11/research_dream/llm-clone/extract_clone_py/output/sampling_clones/manual_inspection_report.html" \
  > "/home/user1-system11/research_dream/llm-clone/extract_clone_py/output/sampling_clones/pipeline_run.log" 2>&1

```

Once execution is complete, you can review the sampling breakdown by executing:
`cat /home/user1-system11/research_dream/llm-clone/extract_clone_py/output/sampling_clones/pipeline_run.log`